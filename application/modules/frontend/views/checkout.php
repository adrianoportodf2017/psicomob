                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control cep required" name="cep" required type="text" value="<?= $patient->cep ?? null ?>" id="cep">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control custom-select" readonly name="pais" id="checkout-country">
                                    <option value="<?= $patient->pais ?? null ?>">Escolher país</option>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control custom-select required" required id="estado" name="estado">
                                    <option value="<?= $patient->estado ?? null ?>"><?= $patient->estado ?? 'Escolher estado' ?></option>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control cidade required" required  name="cidade" value="<?= $patient->estado ?? null ?>" type="text" id="cidade">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control bairro required" name="bairro" required  value="<?= $patient->bairro  ?? null ?>" type="text" id="bairro">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="checkout-address-1">Endereço</label>
                                <input class="form-control required" type="text" name="endereco" required  value="<?= $patient->endereco ?? null ?>" id="endereco">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control required" required type="text" value="<?= $patient->numero  ?? null ?>" name="numero" id="numero">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="checkout-address-2">Complemento</label>
                                <input class="form-control " type="text" name="complemento" value="<?= $patient->complemento ?? null ?>" id="complemento">
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="row">    
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input class="form-control card"  type="text" name="number" placeholder="Número do cartão" required><br>
                                                        </div>                                             
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input class="form-control card" type="text" name="name" placeholder="Nome do Titular do Cartão" required>
                                                        </div> 

                                                        <div class="form-row">

                                                            <div class="col-4">
                                                                <select name="expiryMes" class="form-control card" required>                                                               
                                                            ...
                                                            <div class="col-3">
                                                                <input class="form-control card" type="text" name="expiryAA" placeholder="AA" required maxlength="4">                                                                
                                                            </div>
                                                            <div class="col-5">
                                                                <div class="input-group mb-2">

                                                                    <input class="form-control card" type="text" name="cvc" placeholder="CVV" required>
