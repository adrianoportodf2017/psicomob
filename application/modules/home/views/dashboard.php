                        ...
                        <li id="header_inbox_bar" class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                <span class="badge bg-primary">
                                    <?php
                                    $query = $this->db->get('plans')->num_rows();
                            ...
                            <ul class="dropdown-menu extended inbox">
                                ...
                                <li>
                                    <p class="red"> <?php
                                                    echo lang('number_of_active_plans') . ' ' . $query . ' ';
                                                    ?></p>
                                </li>
                                <li>
                                    <a href="plans">
                                        <p class="green"> <?php echo lang('see_all_plans'); ?></p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="dropdown-menu extended notification">
                                ...
                                <li>
                                    <p class="yellow"><?php
                                                        echo  $query . ' ';
                                                        if ($patient_number <= 1) {
                                                            echo lang('doctor_registerred_today');
                                                        } else {
                                                            echo lang('doctors_registerred_today');
                                                        }
                                                        ?> </p>
                                </li>
                                <li>
                                    <a href="doctor">
                                        <p class="green"><?php echo lang('see_all_doctors'); ?></p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        <li class="sub-menu">
                            <a href="javascript:;">
                                <i class="fa fa-flag"></i>
                                <span><?php echo lang('plans'); ?></span>
                            </a>
                            <ul class="sub">
                                <li><a href="plans"><i class="fa fa-plans"></i><?php echo lang('see_all_plans'); ?></a></li>
                            </ul>
                        </li>
                    <?php } ?>
