...
<body class="login-body">
    ...
    <div class="container">
        ...
        <form class="form-signin" method="post" action="auth/login">
            <h2 class="login form-signin-heading"><?php echo $this->db->get('settings')->row()->title; ?><br /><br />
                <?php

                if (!empty($this->db->get('settings')->row()->logo)) {
                    if (file_exists($this->db->get('settings')->row()->logo)) {
                        echo '<img width="100%" src=' . $this->db->get('settings')->row()->logo . '>';
                    } else {
