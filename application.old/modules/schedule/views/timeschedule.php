                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="center slider">
                                    <div>
                                        <button onclick="verificarHoras('<?php echo strftime('%u - %Y-%m-%d', strtotime('+1 day', strtotime(date('D-m-y')))); ?> ')" class="btn btn-info round button-week"> <?php echo str_replace(',', '<p>', mb_strtoupper(utf8_encode(strftime('HOJE, %d/%m', strtotime('+1 day', strtotime(date("D-m-y"))))))); ?> </button>
                                    ...
                                    <div>
                                        <button onclick="verificarHoras('<?php echo strftime('%u - %Y-%m-%d', strtotime('+9 day', strtotime(date('D-m-y')))); ?> ')" class="btn btn-info round buttonhours"> <?php echo str_replace(',', '<p>', mb_strtoupper(utf8_encode(strftime('%a, %d/%m', strtotime('+9 day', strtotime(date("D-m-y"))))))); ?> </button>
                                    </div>
                                </div>
                                <b>
