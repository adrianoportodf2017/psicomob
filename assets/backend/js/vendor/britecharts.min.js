...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        function drawAllDataPoints() {
            ...
            }).style('planosr', 'pointer').attr('cx', function (d) {
        ...
        /**
         * MouseMove handler, calculates the nearest dataPoint to the planosr
        ...
        function highlightDataPoints(dataPoint) {
            ...
            dataPoint.topics.forEach(function (d, index) {
                ...
                }).style('stroke', topicColorMap[d.name]).style('planosr', 'pointer').on('click', function () {
                    addGlowFilter(this);
  ...
  function brush(group) {
    ...
    group.selectAll(".selection")
      ...
      .enter().append("rect")
        ...
        .attr("planosr", planosrs.selection)
        .attr("fill", "#777")
    ...
    handle.enter().append("rect")
        ...
        .attr("planosr", function(d) { return planosrs[d.type]; });
  ...
  function started() {
    ...
    function move() {
      ...
      if (e1 < w1) {
        ...
        t = w0, w0 = e0, e0 = t;
        t = w1, w1 = e1, e1 = t;
        if (type in flipX) overlay.attr("planosr", planosrs[type = flipX[type]]);
      }
      ...
      if (s1 < n1) {
        ...
        t = n0, n0 = s0, s0 = t;
        t = n1, n1 = s1, s1 = t;
        if (type in flipY) overlay.attr("planosr", planosrs[type = flipY[type]]);
      }
    ...
    function ended() {
      ...
      overlay.attr("planosr", planosrs.overlay);
      ...
      switch (__WEBPACK_IMPORTED_MODULE_3_d3_selection__["event"].keyCode) {
        ...
        case 32: { // SPACE; takes priority over ALT
          if (mode === MODE_HANDLE || mode === MODE_CENTER) {
            ...
            mode = MODE_SPACE;
            overlay.attr("planosr", planosrs.selection);
            move();
          }
          break;
        }
      ...
      switch (__WEBPACK_IMPORTED_MODULE_3_d3_selection__["event"].keyCode) {
        ...
        case 32: { // SPACE
          if (mode === MODE_SPACE) {
            ...
            overlay.attr("planosr", planosrs[type]);
            move();
          }
          break;
        }
